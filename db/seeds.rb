...
channel1 = Channel.create(name: "Netflix")
channel2 = Channel.create(name: "HBO")
channel3 = Channel.create(name: "NOS1")

channel1.movies << [movie1]
channel1.save

channel2.movies << [movie2]
channel2.save

channel3.movies << [movie3]
channel3.save

channel3.movies << [movie4]
channel3.save

channel2.movies << [movie5]
channel2.save

channel1.movies << [movie6]
channel1.save

channel2.movies << [movie7]
channel2.save

channel3.movies << [movie8]
channel3.save
